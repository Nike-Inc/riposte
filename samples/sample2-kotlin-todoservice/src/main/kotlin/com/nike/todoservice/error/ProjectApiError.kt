 ...
 * `message` for any JSR 303 (Java Bean Validation) annotation (e.g. [ ][javax.validation.constraints.NotNull.message] and if that violation is triggered it will be converted by the
 ...
 *
 */
enum class ProjectApiError private constructor(private val delegate: ApiError) : ApiError {
    ...
    private constructor(errorCode: Int, message: String, httpStatusCode: Int, metadata: Map<String, Any>? = null) : this(ApiErrorBase(
