...
public interface DistributedTracingConfig<S> {
    ...
    /**
     * @return The {@link ProxyRouterSpanNamingAndTaggingStrategy} that will control span names and
     * auto-tagging/annotations for the outbound client HTTP calls generated by {@code
     * com.nike.riposte.server.http.ProxyRouterEndpoint} endpoints when the proxied call is made.
     */
    @NotNull ProxyRouterSpanNamingAndTaggingStrategy<S> getProxyRouterSpanNamingAndTaggingStrategy();
